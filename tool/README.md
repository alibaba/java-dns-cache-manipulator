...
<a href="https://github.com/alibaba/java-dns-cache-manipulator/releases/download/v1.6.2/dcm-1.6.2.tar.gz"><img src="https://img.shields.io/github/downloads/alibaba/java-dns-cache-manipulator/v1.6.2/dcm-1.6.2.tar.gz.svg" alt="GitHub release download - dcm.tar.gz)"></a>
