...
<p align="center">
<a href="https://ci.appveyor.com/project/oldratlee/java-dns-cache-manipulator"><img src="https://img.shields.io/appveyor/ci/oldratlee/java-dns-cache-manipulator/dev-1.6.x-java6?logo=appveyor&logoColor=white" alt="Build Status"></a>
<a href="https://coveralls.io/github/alibaba/java-dns-cache-manipulator?branch=dev-1.6.x-java6"><img src="https://img.shields.io/coveralls/github/alibaba/java-dns-cache-manipulator/dev-1.6.x-java6?logo=coveralls&logoColor=white" alt="Coveralls branch"></a>
...
<a href="https://openjdk.java.net/"><img src="https://img.shields.io/badge/Java-6+-red?logo=java&logoColor=white" alt="Java support"></a>
...
<a href="https://search.maven.org/artifact/com.alibaba/dns-cache-manipulator"><img src="https://img.shields.io/maven-central/v/com.alibaba/dns-cache-manipulator?versionPrefix=1.6.&color=red&logo=apache-maven&logoColor=white" alt="Maven Central"></a>
...
[![GitHub release download - dcm.tar.gz)](https://img.shields.io/github/downloads/alibaba/java-dns-cache-manipulator/v1.6.5/dcm-1.6.5.tar.gz.svg?logoColor=white&logo=DocuSign)](https://github.com/alibaba/java-dns-cache-manipulator/releases/download/v1.6.5/dcm-1.6.5.tar.gz) 下载文件`dcm-x.x.x.tar.gz`。
